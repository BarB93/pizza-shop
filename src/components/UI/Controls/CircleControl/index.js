...
const CalcControl = ({ minus, plus, remove, onClick, disabled}) => {
  return (
    <button className={clsx(styles.button, minus && styles.button_minus, remove && styles.button_remove)} disabled={disabled} onClick={onClick}>
      {(minus || plus) && (
